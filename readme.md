...
Example that demonstrates a workflow for detecting a sound using autocorrelation, in this case, A note strings or a E note cathedral organ recorded from Garageband.
